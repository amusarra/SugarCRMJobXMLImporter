...
array_push($job_strings, 'XmlImporterContactsJobs');

function XmlImporterContactsJobs()
{
	$GLOBALS['log']->info('Running: XmlImporterContactsJobs');
	...
	$GLOBALS['log']->info('End: XmlImporterContactsJobs');
